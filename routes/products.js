...
//GET: get a category by its id (this is used for the categories navbar & wherever we want to get products by category)
router.get("/:id", async (req, res) => {
  ...
  try {
    ...
    res.render("shop/new_index", {
      ...
      home: "/products/" + req.params.id.toString() + "/?",
      pages: Math.ceil(count / perPage),
    });
  } catch (error) {
    console.log(error);
...
// GET: display a product detail page by its id
